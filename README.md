...
## Options
  ...
  Usage: cupp.py [OPTIONS]
        ...
        -i      trả lời các câu hỏi để tạo passlist 

        -w      sử dụng một passlist có sẳn

        -l      tải một passlist online
        -a      Phân tích id và pass bằng pp Alecto DB.
                
        -v      phiên bản phần mềm
